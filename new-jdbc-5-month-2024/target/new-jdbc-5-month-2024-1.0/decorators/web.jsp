...
<head>
	...
	<link href=" <c:url value='template/web/fonts/iconic/css/material-design-iconic-font.min.css'/>" rel="stylesheet"
		type="text/css" />
	<!--===============================================================================================-->
	<link href="template/web/vendor/animate/animate.css" rel="stylesheet" type="text/css" />
	<!--===============================================================================================-->
	<link href="template/web/vendor/css-hamburgers/hamburgers.min.css" rel="stylesheet" type="text/css" />
	<!--===============================================================================================-->
	<link href="template/web/vendor/animsition/css/animsition.min.css" rel="stylesheet" type="text/css" />
	<!--===============================================================================================-->
	<link href="template/web/css/util.min.css" rel="stylesheet" type="text/css" />
	<!--===============================================================================================-->
